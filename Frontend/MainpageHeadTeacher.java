...
public class MainpageHeadTeacher extends JFrame {
    ...
    //     };
        ...
        //         Backend.src.department.ManageDepartment.main(null);
        //     } else {
        //         JOptionPane.showMessageDialog(loginDialog,
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            MainpageHeadTeacher frame = new MainpageHeadTeacher();
