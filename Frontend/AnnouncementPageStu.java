...
import Backend.src.database.AnnouncementManager;
    ...
    public class AnnouncementPageStu extends JFrame {
        ...
        public AnnouncementPageStu() {
            this.session = UserSession.getInstance();
             Backend.src.database.AnnouncementManager.createAnnouncementsTable(); 
        ...
        private JButton createBackButton() {
            ...
            button.addActionListener(e -> {
                MainPageStudentGUI studentPage = new MainPageStudentGUI();
        ...
        public static void main(String[] args) {
            SwingUtilities.invokeLater(() -> new AnnouncementPageStu().setVisible(true));
        }
    }
