...
public class UpdateStudentGUI extends JDialog {
    ...
    public UpdateStudentGUI(JDialog parent) {
        super(parent, "Update Student Department", true);
        setSize(600, 700);
    ...
    private void initComponents() {
        ...
        headerLabel.setBounds(50, 20, 500, 35);
        ...
        studentInfoLabel.setBounds(20, yPos, 460, 40);
        ...
        currentAssignmentLabel.setBounds(20, yPos, 460, 60);
        ...
        submitButton.addActionListener(e -> updateStudent());
    ...
    private void checkStudent() {
        ...
        if (existingDeptMajor != null) {
            currentAssignmentLabel.setText("<html><b>Current Assignment:</b><br>" + 
                                          "Department: " + existingDeptMajor[0] + "<br>" +
                                          "Major: " + existingDeptMajor[1] + "</html>");
        } else {
            currentAssignmentLabel.setText("<html><b style='color: #e74c3c;'>⚠ No current assignment found</b></html>");
        }
    }
    ...
    private void updateStudent() {
        ...
        if (department == null || department.equals("-- Select Department --")) {
            JOptionPane.showMessageDialog(this,
                    "Please select a new department.",
                    "Selection Required",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        String[] currentDeptMajor = MajorManager.getDepartmentMajor(studentId);
        String oldInfo = "None";
        if (currentDeptMajor != null) {
            oldInfo = currentDeptMajor[0] + " - " + currentDeptMajor[1];
        }

        // Update assignment
        if (MajorManager.updateDepartmentMajor(studentId, department, selectedMajor)) {
            JOptionPane.showMessageDialog(this,
                    "Student updated successfully!\n\n" +
                            "Student: " + studentInfo[1] + "\n" +
                            "Previous: " + oldInfo + "\n" +
                            "New Department: " + department + "\n" +
                            "New Major: " + selectedMajor,
                    "Success",
